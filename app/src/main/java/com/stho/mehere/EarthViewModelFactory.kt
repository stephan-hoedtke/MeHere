...
class EarthViewModelFactory(private val application: Application, private val repository: Repository) :
    ViewModelProvider.AndroidViewModelFactory(application) {

    override fun <T : ViewModel?> create(modelClass: Class<T>): T {
        val viewModel = when {
            modelClass.isAssignableFrom(EarthViewModel::class.java) -> EarthViewModel(application, repository)
...
fun EarthFragment.createEarthViewModel(): EarthViewModel {
    ...
    val viewModelFactory = EarthViewModelFactory(application, repository)
